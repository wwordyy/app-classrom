    ...
    return (
        ...
        <div className="bg-black rounded-3xl px-16 py-12 flex gap-16 items-start shadow-xl w-full max-w-5xl">
            ...
            <div className="space-y-2">
                ...
                className="w-full bg-transparent border border-[#3c4043] rounded-md 
                                    px-3 py-3 text-white text-base focus:outline-none 
                                    focus:border-white focus:ring-1 "
                required
                minLength={6}/>
            </div>
